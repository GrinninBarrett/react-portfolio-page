        ...
        >
          ...
          <div id="footer-nav-links">
            <ul id="footer-nav-menu" className="flex-item nav-list">
              ...
              <NavHashLink
                className="main-nav-item nav-item link light-link"
                to="/react-portfolio-page/projects"
                activeStyle={{
                  backgroundColor: "rgb(238, 238, 238)",
                  color: "#47684a"
                }}
              ...
              <NavHashLink
                className="main-nav-item nav-item link light-link"
                to="/react-portfolio-page/contact"
                activeStyle={{
                  backgroundColor: "rgb(238, 238, 238)",
                  color: "#47684a"
                }}
          ...
          <div id="footer-social-links">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Go to Tucker's GitHub profile"
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Go to Tucker's LinkedIn Profile"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Go to Tucker's Instagram profile"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
