            ...
            <section id="about-intro" className="intro container flex-item">
                <div className="top-intro-container flex-item">
                    <picture>
                        ...
                        <img className="tucker-photo" src="./assets/images/tucker-photo-3.png" 
                            height="350px" width="350px" alt="Tucker wearing a cat sweatshirt and cat blazer" />
                    </picture>
                    <div id="about-text-container" className="flex-item flex-column">
                        <h1 className="base-text">A bit about me</h1>
                        <p className="base-text">
                            My background is education - I have taught music for 4 years, with a 4-year break in the middle to live in South Korea and teach ESL. 
                            While music is something I plan to enjoy forever, I realized some time ago that public school teaching is not.
                        </p>
                        <p className="base-text">
                            As someone who always loved tech, but was too deeply involved in the pursuit of a career in music, I long 
                            viewed the field of technology as something not meant for a musical creative like me. I've realized, now, that I was very wrong. 
